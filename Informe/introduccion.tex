...
que corresponde al \textif{Capitulo I} que es una introduccion la cual explica las necesidades 
que motivaron el desarrollo del mismo y un resumen general de lo que se pretende implementar 
con el mismo. 

En el \textif{Capitulo II} se refiere en cuanto a la tecnologia que 
se decidio utilizar. 

% En revision no se incluir
El \textif{Capitulo II bis} trata sobre las etapas del desarrollo del mismo y 
las diferentes metas alcansadas.

El \textif{Capitulo III} Esplica la problematica y el funcionamiento
de los actuales sistemas aplicados al area. 

El \textif{Capitulo IV} habla sobre cuestiones
...
El \textif{Capitulo V} no guia en la implementacion del sistema, los requerimientos del 
mismos y toda la configuracion necesaria para lograr una correcta instalacion y 
funcionamiento del mismo.

Por ultimo el \textif{Capitulo VI} es una conclucion, que analiza el desarrollo del mismo, 
