...
Cabe aclarar que el Super Usuario del sistema de Autenticacion de Django dentro 
del sistema en si mismo no posee ningun privilegio adicional, es mas para 
